...
Remaining before Cohort 1: the Docside intro capture asset (screen 2); Phase 5 env wiring (`SUPABASE_URL`, `SUPABASE_SERVICE_ROLE_KEY`, `SCHEDULE_URL` — blocked on the `first_look` schema migration + provisioning, Phase 4/5).
